...
STEP:
first character is key to check next characters
if character is not sequence, push to new array and then join it to make it to string
problem: how to make the characters check sequence
- find index of first character
- check the sequenced character to the array sequece
